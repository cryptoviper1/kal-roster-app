    ...
    <div className="max-w-4xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
      ...
      <div className="prose prose-blue max-w-none">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-bold text-gray-900 mb-3">제 1 조 (목적)</h2>
          <p>
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-bold text-gray-900 mb-3">제 2 조 (제공되는 서비스)</h2>
          <p>본 서비스는 다음과 같은 주요 기능을 제공합니다.</p>
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-bold text-gray-900 mb-3">제 3 조 (사용자의 의무 및 제한 사항)</h2>
          <ul className="list-disc pl-6 space-y-2 mt-2">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-bold text-gray-900 mb-3">제 4 조 (구글 계정 연동 및 API 사용)</h2>
          <p>
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-bold text-gray-900 mb-3">제 5 조 (책임의 한계 및 면책)</h2>
          <p>
